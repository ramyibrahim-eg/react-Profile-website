...
const NotFound = () => {
  return (
    <main className="h-screen w-full flex flex-col justify-center items-center">
      ...
      <div className="bg-[#ff014f] px-2 text-sm rounded rotate-12 absolute">
        Page Not Found
      </div>
      <button className="mt-5">
        <a className="relative inline-block text-sm font-medium text-[#ff014f] group active:text-orange-500 focus:outline-none focus:ring">
